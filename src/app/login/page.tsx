  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-amber-50">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-amber-100 p-8">
        <h1 className="text-2xl font-semibold text-amber-800 text-center mb-1">
          {t("common.appName")}
        </h1>
        <p className="text-sm text-amber-500 text-center mb-8">
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 bg-amber-400 hover:bg-amber-500 text-white font-medium rounded-lg text-sm transition-colors disabled:opacity-50"
          >
            {loading
              ? t("login.loadingBtn")
              : isSignUp
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 py-2 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          >
            {isSignUp ? t("login.goSignIn") : t("login.goSignUp")}
          </button>
        </p>
      </div>
    </main>
