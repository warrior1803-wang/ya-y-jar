...
export default function SlipCard({ content, date, triggered, onOpen, onReset }: SlipCardProps) {
    ...
    >
      ...
      >
        <motion.div animate={textCtrl} initial={{ opacity: 0, y: 8 }}>
          {/* Date — top right */}
          <p style={{ textAlign: 'right', fontSize: '12px', color: '#C4A99A', fontFamily: FONT, marginBottom: '8px' }}>
            {date}
          </p>

          {/* Content */}
          <p style={{ fontFamily: FONT, fontSize: '18px', lineHeight: `${LINE_H}px`, color: '#3D2B1F', whiteSpace: 'pre-wrap' }}>
            {content}
          </p>
        ...
        {isFolded && (
          <motion.div
            ...
            style={{
              ...
              inset: 0,
              backgroundColor: '#FFF9F4',
              boxShadow: 'inset 0 0 0 2px #EDD9C8, 2px 2px 0 #EDD9C8, 4px 4px 0 #E8D4BE',
              borderRadius: '4px',
              display: 'flex',
              alignItems: 'center',
