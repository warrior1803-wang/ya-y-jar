  ...
  return (
    <>
      ...
      >
        ...
        {entries.length > 0 && (
          <p style={{ fontFamily: FONT, fontSize: 13, color: '#7A5C4F', margin: 0 }}>
      ...
      >
        ...
        {/* Write form */}
        <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: 384, display: 'flex', flexDirection: 'column', gap: 24 }}>
